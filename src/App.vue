  ...
  <div class="page-wrapper with-navbar with-sidebar with-navbar-fixed-bottom"
        ...
        <nav class="navbar">
            ...
            <div class="navbar-content ml-auto">
                <button class="btn btn-action mr-5" type="button" @click="toggleMode"
        ...
        <div class="sidebar" id="sidebar">                       
            <div class="sidebar-menu list">
                ...
                <router-link v-if="sibebarMenu1 != ''" to="/menu1" class="sidebar-link" id="sidebar-menu-1" data-active-scroll-disabled="disabled">
                    <span class="name">{{ sibebarMenu1 }}</span>
                </router-link>         

                <a href="#" v-if="sibebarMenu2 != ''" class="sidebar-link" id="sidebar-menu-2" data-active-scroll-disabled="disabled">
                    <span class="name">{{ sibebarMenu2 }}</span>
                </a>

                <a href="#" v-if="sibebarMenu3 != ''" class="sidebar-link" id="sidebar-menu-3" data-active-scroll-disabled="disabled">
